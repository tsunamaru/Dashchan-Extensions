...
public class TwowatchChanLocator extends ChanLocator
{
	...
	public TwowatchChanLocator()
	{
		addChanHost("2watch.su");
		addConvertableChanHost("2watch.in");
		addConvertableChanHost("www.2watch.su");
		addConvertableChanHost("www.2watch.in");
	}
