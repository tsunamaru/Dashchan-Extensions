...
public class TwowatchChanMarkup extends ChanMarkup
{
	private static final int SUPPORTED_TAGS = TAG_BOLD | TAG_ITALIC | TAG_UNDERLINE | TAG_STRIKE | TAG_SPOILER
			| TAG_CODE | TAG_ASCII_ART;
	
	public TwowatchChanMarkup()
	{
		addTag("b", TAG_BOLD);
		addTag("i", TAG_ITALIC);
		...
		addTag("span", "style", "font-family: Mona,'MS PGothic' !important;", TAG_ASCII_ART);
