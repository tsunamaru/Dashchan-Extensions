...
public class ArchiveLiomChanPerformer extends ChanPerformer
{
	@Override
	public ReadThreadsResult onReadThreads(ReadThreadsData data) throws HttpException, InvalidResponseException
	{
		ArchiveLiomChanLocator locator = ChanLocator.get(this);
		...
		try
		{
			return new ReadThreadsResult(new ArchiveLiomPostsParser(responseText, this).convertThreads());
		}
			...
			InvalidResponseException
	{
		...
		try
		{
			...
			return new ReadPostsResult(new ArchiveLiomPostsParser(responseText, this).convertPosts(threadUri));
		}
		catch (ParseException e)
		{
			throw new InvalidResponseException(e);
	...
	public ReadBoardsResult onReadBoards(ReadBoardsData data) throws HttpException, InvalidResponseException
	{
		...
		try
		{
			return new ReadBoardsResult(new ArchiveLiomBoardsParser(responseText).convert());
		}
		catch (ParseException e)
		{
			throw new InvalidResponseException(e);
