			...
			throws JSONException
	{
		...
		if (extraData != null)
		{
			...
			if (index1 >= 0 && index2 > index1)
			{
				...
				{
					Uri osIconUri = null;
					if (osArray[i].startsWith("Windows")) osIconUri = URI_ICON_WINDOWS;
					else if (osArray[i].startsWith("Linux")) osIconUri = URI_ICON_LINUX;
					else if (osArray[i].startsWith("Ubuntu")) osIconUri = URI_ICON_LINUX;
					else if (osArray[i].startsWith("Mac")) osIconUri = URI_ICON_APPLE;
					else if (osArray[i].startsWith("iOS")) osIconUri = URI_ICON_APPLE;
					else if (osArray[i].startsWith("Android")) osIconUri = URI_ICON_ANDROID;
					String os;
				...
				for (int i = 0; i < browserArray.length; i++)
				{
					...
					if (browserArray[i].startsWith("Chrom")) browserIconUri = URI_ICON_CHROME;
					else if (browserArray[i].startsWith("Firefox")) browserIconUri = URI_ICON_FIREFOX;
					else if (browserArray[i].startsWith("Iceweasel")) browserIconUri = URI_ICON_FIREFOX;
					else if (browserArray[i].startsWith("Edge")) browserIconUri = URI_ICON_EDGE;
					else if (browserArray[i].startsWith("IE")) browserIconUri = URI_ICON_EDGE;
					else if (browserArray[i].startsWith("Opera")) browserIconUri = URI_ICON_OPERA;
					else if (browserArray[i].startsWith("Vivaldi")) browserIconUri = URI_ICON_VIVALDI;
					else if (browserArray[i].startsWith("Safari")) browserIconUri = URI_ICON_SAFARI;
					String browser;
