...
public class RuletBoardsParser implements GroupParser.Callback
{
	...
	public RuletBoardsParser(String source)
	{
		mSource = source;
	}
	...
	public void onGroupComplete(GroupParser parser, String text)
	{
		switch (mExpect)
		{
			...
			case EXPECT_BOARD:
			{
				...
				text = text.substring(0, 1).toUpperCase(Locale.getDefault()) + text.substring(1);
