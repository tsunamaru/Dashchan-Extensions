...
public class RuletChanLocator extends ChanLocator
{
	...
	public RuletChanLocator()
	{
		addChanHost("2-chru.net");
		addChanHost("mirror.2-chru.net");
		addChanHost("bypass.2-chru.net");
