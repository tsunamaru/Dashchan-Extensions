...
public class NulldvachnetPostsParser
{
	private final String mSource;
	private final NulldvachnetChanConfiguration mConfiguration;
	private final NulldvachnetChanLocator mLocator;
	...
	public NulldvachnetPostsParser(String source, Object linked, String boardName)
	{
		mSource = source;
		mConfiguration = NulldvachnetChanConfiguration.get(linked);
		mLocator = NulldvachnetChanLocator.get(linked);
	...
	private static final TemplateParser<NulldvachnetPostsParser> PARSER = new TemplateParser<NulldvachnetPostsParser>()
	...
	}).equals("img", "class", "image").open((instance, holder, tagName, attributes) ->
	{
		...
		if (src != null)
		{
			...
			holder.mAttachment.setSpoiler(src.contains("/img/spoiler.png"));
		}
