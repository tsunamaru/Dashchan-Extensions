...
public class NowereChanLocator extends ChanLocator
{
	...
	public String getThreadNumber(Uri uri)
	{
		...
		if (threadNumber == null) threadNumber = getGroupValue(path, THREAD_ARCHIVE_PATH, 1);
		if (threadNumber == null) threadNumber = getGroupValue(path, ATTACHMENT_ARCHIVE_PATH, 1);
		return threadNumber;
	}
