...
public class TouhouchanChanLocator extends ChanLocator {
	private static final Pattern BOARD_PATH = Pattern.compile("/\\w+(?:/(?:(?:wakaba|\\d+)\\.html)?)?");
	...
	public TouhouchanChanLocator() {
		addConvertableChanHost("touhouchan.org");
		addChanHost("www.touhouchan.org");
