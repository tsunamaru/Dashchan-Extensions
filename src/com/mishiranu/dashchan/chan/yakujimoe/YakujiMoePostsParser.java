...
public class YakujiMoePostsParser {
	private final String source;
	private final YakujiMoeChanConfiguration configuration;
	private final YakujiMoeChanLocator locator;
	...
	public YakujiMoePostsParser(String source, Object linked, String boardName) {
		this.source = source;
		configuration = YakujiMoeChanConfiguration.get(linked);
		locator = YakujiMoeChanLocator.get(linked);
