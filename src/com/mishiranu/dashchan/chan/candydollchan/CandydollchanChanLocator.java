...
public class CandydollchanChanLocator extends ChanLocator {
	...
	public CandydollchanChanLocator() {
		addConvertableChanHost("candydollchan.org");
		addChanHost("www.candydollchan.org");
