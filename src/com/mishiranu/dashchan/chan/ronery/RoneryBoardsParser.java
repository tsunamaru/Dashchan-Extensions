...
public class RoneryBoardsParser implements GroupParser.Callback
{
	...
	public RoneryBoardsParser(String source)
	{
		mSource = source;
	}
	...
	public void onGroupComplete(GroupParser parser, String text)
	{
		switch (mExpect)
		{
			...
			{
				if ("Boards".equals(text)) mBoardCategoryTitle = StringUtils.clearHtml(text);
				else mBoardCategoryTitle = null;
				break;
			}
			case EXPECT_BOARD:
			{
