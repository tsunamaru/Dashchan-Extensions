...
public class RoneryChanLocator extends ChanLocator
{
	...
	private static final Pattern ATTACHMENT_PATH = Pattern.compile("/foolfuuka/boards/\\w+/image/"
			+ "\\d+/\\d+/\\d+\\.\\w+");
	
	public RoneryChanLocator()
	{
		addChanHost("ronery.me");
		addConvertableChanHost("www.ronery.me");
	...
	public String getBoardName(Uri uri)
	{
		...
		if (segments.size() > 0)
		{
			...
			if ("foolfuuka".equals(segment) && segments.size() > 2 && "boards".equals(segments.get(1)))
			{
