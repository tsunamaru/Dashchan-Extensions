...
public class NulleuPostsParser {
	...
	private static final TemplateParser<NulleuPostsParser> PARSER = new TemplateParser<NulleuPostsParser>()
		...
		if (holder.headerHandling) {
			...
			.equals("img", "class", "_country_").open((instance, holder, tagName, attributes) -> {
	...
	}).equals("table", "class", "postform").open((i, h, t, a) -> !(h.hasPostBlock = true))
